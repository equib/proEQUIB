function calc_temp_dens, ion, levu, levl, inratio, diagnostic_type, fixedq
;+
; NAME:
;     calc_temp_dens
; PURPOSE:
...
;     temp=calc_temp_dens(ion, levu, levl, niiTratio, diagnostic_type, dens) 
;     print, temp
;
;     ion='sii'
;     levu='1,2/'
...
;     dens=calc_temp_dens(ion, levu, levl, siiNratio, diagnostic_type, temp)
;     print, dens
;
; INPUTS:
...
;                 electron density when diagnostic_type ='t' or 'T'
;                 electron temperature when diagnostic_type ='d' or 'D'
; RETURN:  density or temperature
;                 electron density when diagnostic_type ='d' or 'D'
;                 electron temperature when diagnostic_type ='t' or 'T'
; REVISION HISTORY:
...
; 2009-04    R.Wesson     Converted to F90, inputs from cmd line, version 
