...
; used from /mgunit/lib/unit/mgutlibtestcase__define.pro
; in https://github.com/mgalloy/mgunit
;-

function proequibuttestcase::have_dlm, dlm_name
...
pro proequibuttestcase::teardown
  compile_opt strictarr
...
pro proequibuttestcase::cleanup
  compile_opt strictarr
...
function proequibuttestcase::init, _extra=e
  compile_opt strictarr
...
pro proequibuttestcase__define
  compile_opt strictarr

  define = { proEquibUTTestCase, inherits MGutTestCase, $
             nptrs: 0L, $
             nobjs: 0L, $
